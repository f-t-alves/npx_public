...
class Ui_LabInput(QtGui.QWidget):
    ...
    def retranslateUi(self, LabInput):
        LabInput.setWindowTitle(QtGui.QApplication.translate("LabInput", "Frame", None, QtGui.QApplication.UnicodeUTF8))
        self.Phone2Label.setText(QtGui.QApplication.translate("LabInput", "Telefone 2", None, QtGui.QApplication.UnicodeUTF8))
        self.Phone1Label.setText(QtGui.QApplication.translate("LabInput", "Telefone 1", None, QtGui.QApplication.UnicodeUTF8))
        self.FaxLabel.setText(QtGui.QApplication.translate("LabInput", "Fax", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.Email1Label.setText(QtGui.QApplication.translate("LabInput", "E-mail 1", None, QtGui.QApplication.UnicodeUTF8))
        self.Email2Label.setText(QtGui.QApplication.translate("LabInput", "E-mail 2", None, QtGui.QApplication.UnicodeUTF8))
        self.EnderLabel.setText(QtGui.QApplication.translate("LabInput", "Endereço", None, QtGui.QApplication.UnicodeUTF8))
